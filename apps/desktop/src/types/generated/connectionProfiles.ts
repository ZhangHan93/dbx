...
export const CONNECTION_PROFILES = {
  ...
  "firebird-embedded": { type: "firebird-embedded", port: 0, user: "SYSDBA", label: "Firebird Embedded", icon: "firebird" },
  ...
  odbc: { type: "odbc", port: 0, user: "", label: "ODBC", icon: "odbc" },
  odbc32: { type: "odbc32", port: 0, user: "", label: "ODBC (32-bit)", icon: "odbc" },
...
export const CONNECTION_PICKER_OPTIONS = [
  ...
  { value: "firebird-embedded", label: "Firebird Embedded", category: "sql" },
  ...
  { value: "odbc", label: "ODBC", category: "sql" },
  { value: "odbc32", label: "ODBC (32-bit)", category: "sql" },
