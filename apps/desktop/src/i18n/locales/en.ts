...
export default {
  ...
  connection: {
    ...
    odbcDsnEmpty: "No matching DSN",
    odbcDsnInvalidChars: "DSN name must not contain ; {'{'} or {'}'}",
    odbcDsnHiddenByBitness: "{count} more DSN(s) not listed - only visible to the other bitness",
