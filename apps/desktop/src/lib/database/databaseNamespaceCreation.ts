...
export const DATABASE_NAMESPACE_CREATION_MATRIX = {
  ...
  odbc: { deferred: "generic ODBC does not expose a reliable dialect-specific create target" },
  odbc32: { deferred: "generic ODBC does not expose a reliable dialect-specific create target" },
